...
| **Exact copy** | `VERBATIM`: "Great Pins get buried" / "Weak titles, keywords and boards keep your best Pins out of Pinterest search. Fix them and the Pins you've already posted start surfacing every time someone searches for what you posted about." + impact chain Found → Reach → Clicks → Earnings and the line "Works on the Pins you've already posted — nothing new to make."; "AI that tunes everything" / "It rewrites, re-keywords and reorganizes your whole Pinterest — automatically."; "Your score is waiting" / "See exactly what's holding your Pinterest growth back." / CTA "Check Your Pinterest SEO Score". |
| **Priority** | **P1** |
